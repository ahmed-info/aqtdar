...
<body class="navbar-fixed sidebar-nav fixed-nav">
    ...
    <div class="sidebar">
        <nav class="sidebar-nav">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('dashboard.slide.index') }}"><i class="icon-puzzle"></i>سلايد</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="{{ route('dashboard.activityStuation.index') }}"><i
                            class="icon-puzzle"></i>الموقف السياسي او النشاط</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="{{ route('dashboard.member.index') }}"><i class="icon-puzzle"></i>من
                        نحن</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="icon-puzzle"></i>رؤيتنا</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="{{ route('dashboard.join.index') }}"><i class="icon-puzzle"></i>طلبات
                        الانضمام</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('dashboard.socialmedia.edit') }}"><i
                            class="icon-puzzle"></i>التواصل الاجتماعي</a>
                </li>
    ...
    <footer class="footer">
        ...
        <span class="pull-right">
            Powered by <a href="/">اقتدار وطن</a>
        </span>
    </footer>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/js22/bootstrap.bundle.min.js"
